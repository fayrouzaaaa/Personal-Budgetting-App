...
public class DashboardScreen extends JFrame{
    ...
    DashboardScreen(Regular_User user){
        ...
        hello.setBounds(80,-100,700,300);
        hello.setFont(new Font("Segoe UI", Font.BOLD, 30));
        this.add(hello);
    ...
    public void showSummary() {
        ...
        summary.setBounds(100, 90, 540, 200);
        ...
        totalBalance.setFont(new Font("Segoe UI", Font.PLAIN, 20));
        ...
        balanceAmount.setFont(new Font("Segoe UI", Font.BOLD, 50));
        ...
        income.setFont(new Font("Segoe UI", Font.PLAIN, 15));
        ...
        incomeAmount.setFont(new Font("Segoe UI", Font.BOLD, 20));
        ...
        expense.setFont(new Font("Segoe UI", Font.PLAIN, 15));
        ...
        expenseAmount.setFont(new Font("Segoe UI", Font.BOLD, 20));
        ...
        transactionsSummary.setBounds(100, 310, 160, 100);
        ...
        transactions.setFont(new Font("Segoe UI", Font.PLAIN, 20));
        ...
        transactionCount.setFont(new Font("Segoe UI", Font.BOLD, 50));
        ...
        budgetSummary.setBounds(290, 310, 160, 100);
        ...
        budgets.setFont(new Font("Segoe UI", Font.PLAIN, 20));
        ...
        goalCount.setFont(new Font("Segoe UI", Font.BOLD, 50));
    ...
    public void showRecentTransactions(){
        ...
        recent.setBounds(100,300, 400, 300);
        recent.setFont(new Font("Segoe UI", Font.BOLD, 30));
        this.add(recent);
